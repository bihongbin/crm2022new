...
<link href="query/bootstrap_3.3.0/css/bootstrap.min.css" type="text/css" rel="stylesheet" />
...
<script type="text/javascript" src="query/bootstrap_3.3.0/js/bootstrap.min.js"></script>
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<!--如果stage就是当前所在的阶段，图标显示为map-marker 颜色为绿色-->
